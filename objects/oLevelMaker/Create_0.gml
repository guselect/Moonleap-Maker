...
obj[OBJECT_TYPE.NEUTRAL, 11] =	new LMObject(oSnailNight,		16, 16, SPRITE_ORIGIN.BOTTOM).add_tag("can_flip").set_sprite_button_part(-11, 0, 0, 2, 18);
...
obj[OBJECT_TYPE.DAY, 12] =	new LMObject(oLadyGiant,		48, 16, SPRITE_ORIGIN.CENTER).add_tag("can_flip").set_sprite_button_part(-8, -8, 19, 1);
obj[OBJECT_TYPE.DAY, 13] =	new LMObject(oLadyGiant4,		64, 16, SPRITE_ORIGIN.CENTER).add_tag("can_flip").set_sprite_button_part(-8, -8, 14, 1);
obj[OBJECT_TYPE.DAY, 14] =	new LMObject(oBatGiant,			48, 16, SPRITE_ORIGIN.CENTER).add_tag("can_flip").set_sprite_button_part(-8, -8, 17, 1);
obj[OBJECT_TYPE.DAY, 15] =	new LMObject(oBatSuperGiant,	64, 16, SPRITE_ORIGIN.CENTER).add_tag("can_flip").set_sprite_button_part(-8, -8, 12, 1);
...
obj[OBJECT_TYPE.NIGHT, 05] =	new LMObject(oKeyTall,			32, 16).set_sprite_button_part(-8, -8, 0, 8);
obj[OBJECT_TYPE.NIGHT, 06] =	new LMObject(oKeyDoorTall,		32, 16).set_sprite_button_part(-8, -8, 0, 8);
obj[OBJECT_TYPE.NIGHT, 07] =	new LMObject(oKeyWide,			32, 16).set_sprite_button_part(-8, -8, 8, 0);
obj[OBJECT_TYPE.NIGHT, 08] =	new LMObject(oKeyDoorWide,		32, 16).set_sprite_button_part(-8, -8, 8, 0);
