...
obj[0, 10] =	new LMObject(oSnail,			16, 16, SPRITE_ORIGIN.BOTTOM).add_tag("can_flip").set_sprite_button_part(-9, 0, 0, 2);
obj[0, 11] =	new LMObject(oSnailNight,		16, 16, SPRITE_ORIGIN.BOTTOM).add_tag("can_flip").set_sprite_button_part(-11, 0, 0, 2, 18);
obj[0, 12] =	new LMObject(oLady,				16, 16, SPRITE_ORIGIN.CENTER).add_tag("can_spin", "can_flip");
obj[0, 13] =	new LMObject(oBat,				16, 16, SPRITE_ORIGIN.CENTER).add_tag("can_flip", "grid_16").set_sprite_button_part(-7, -8, 10, 4);
obj[0, 14] =	new LMObject(oPlatGhost,		16, 16);
obj[0, 15] =	new LMObject(oSolidRamp,		32, 16, SPRITE_ORIGIN.CENTER).add_tag("can_flip").set_sprite_button_part(-8, -8, 16, 0);
...
obj[1, 08] =	new LMObject(oBatVer,			16, 16, SPRITE_ORIGIN.CENTER).add_tag("can_flip").set_sprite_button_part(-7, -8, 10, 4);
...
obj[1, 12] =	new LMObject(oLadyGiant,		48, 16, SPRITE_ORIGIN.CENTER).add_tag("can_flip").set_sprite_button_part(-8, -8, 19, 1);
obj[1, 13] =	new LMObject(oLadyGiant4,		64, 16, SPRITE_ORIGIN.CENTER).add_tag("can_flip").set_sprite_button_part(-8, -8, 14, 1);
obj[1, 14] =	new LMObject(oBatGiant,			48, 16, SPRITE_ORIGIN.CENTER).add_tag("can_flip").set_sprite_button_part(-8, -8, 21, 1);
obj[1, 15] =	new LMObject(oBatSuperGiant,	64, 16, SPRITE_ORIGIN.CENTER).add_tag("can_flip").set_sprite_button_part(-8, -8, 12, 1);
...
obj[2, 05] =	new LMObject(oKeyTall,			32, 16).set_sprite_button_part(-8, -8, 0, 8);
obj[2, 06] =	new LMObject(oKeyDoorTall,		32, 16).set_sprite_button_part(-8, -8, 0, 8);
obj[2, 07] =	new LMObject(oKeyWide,			32, 16).set_sprite_button_part(-8, -8, 8, 0);
obj[2, 08] =	new LMObject(oKeyDoorWide,		32, 16).set_sprite_button_part(-8, -8, 8, 0);
obj[2, 09] =	new LMObject(oKeyTallWide,		32, 32).set_sprite_button_part(-8, -8, 0, 0);
obj[2, 10] =	new LMObject(oKeyDoorTallWide,	32, 32).set_sprite_button_part(-8, -8, 0, 0);
