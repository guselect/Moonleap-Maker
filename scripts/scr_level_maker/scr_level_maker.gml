...
function level_maker_get_objects_list() {
	...
	_obj[0, 00] =	new LMObject(oPlayer,			16, 16, SPRITE_ORIGIN.BOTTOM).add_tag("is_unique").set_can_change(true);
	...
	_obj[0, 14] =	new LMObject(oLady,				16, 16, SPRITE_ORIGIN.CENTER).add_tag("can_flip").set_can_change(true);
	_obj[0, 15] =	new LMObject(oBat,				16, 16, SPRITE_ORIGIN.CENTER).add_tag("can_flip", "grid_16").set_sprite_button_part(sBat, 0, 10, 4, -7, -8).set_can_change(true);
	
	_obj[1, 00] =	new LMObject(oPlayerDir,		16, 16, SPRITE_ORIGIN.BOTTOM).add_tag("is_player").set_can_change(true);
	...
	_obj[1, 04] =	new LMObject(oStarColor,		16, 16).set_can_change(true);
	_obj[1, 05] =	new LMObject(oStarRunningColor,	16, 16).set_can_change(true);
	...
	_obj[1, 10] =	new LMObject(oLadyVer,			16, 16, SPRITE_ORIGIN.CENTER).add_tag("can_flip", "is_vertical").set_sprite_button_part(sLadyVerUI, 0, 3, 1, -8, -8).set_can_change(true);
	_obj[1, 11] =	new LMObject(oLadyGiant,		48, 16, SPRITE_ORIGIN.CENTER).add_tag("can_flip").set_sprite_button_part(sLadyGiant, 0, 19, 1, -8, -8).set_can_change(true);
	_obj[1, 12] =	new LMObject(oLadyGiant4,		64, 16, SPRITE_ORIGIN.CENTER).add_tag("can_flip").set_sprite_button_part(sLadyGiant4, 0, 14, 1, -8, -8).set_can_change(true);
	_obj[1, 13] =	new LMObject(oBatVer,			16, 16, SPRITE_ORIGIN.CENTER).add_tag("can_flip", "grid_16", "is_vertical").set_preview_index_vertical(1).set_sprite_button_part(sBatDown, 0, 10, 4, -7, -8).set_can_change(true);
	_obj[1, 14] =	new LMObject(oBatGiant,			48, 16, SPRITE_ORIGIN.CENTER).add_tag("can_flip").set_sprite_button_part(sBatGiant, 0, 21, 1, -8, -8).set_can_change(true);
	_obj[1, 15] =	new LMObject(oBatSuperGiant,	64, 16, SPRITE_ORIGIN.CENTER).add_tag("can_flip").set_sprite_button_part(sBatGiant4, 0, 12, 1, -8, -8).set_can_change(true);
	...
	_obj[2, 02] =	new LMObject(oKey,				16, 16).set_can_change(true);
	_obj[2, 03] =	new LMObject(oKeyDoor,			16, 16).set_can_change(true);
	_obj[2, 04] =	new LMObject(oKeyTall,			16, 32).set_sprite_button_part(sKeyDoorTallUI, 0, 0, 8, -8, -8).set_can_change(true);
	_obj[2, 05] =	new LMObject(oKeyDoorTall,		16, 32).set_sprite_button_part(sKeyDoorTall, 0, 0, 8, -8, -8).set_can_change(true);
	_obj[2, 06] =	new LMObject(oKeyWide,			32, 16).set_sprite_button_part(sKeyDoorWideUI, 0, 8, 0, -8, -8).set_can_change(true);
	_obj[2, 07] =	new LMObject(oKeyDoorWide,		32, 16).set_sprite_button_part(sKeyDoorWide, 0, 8, 0, -8, -8).set_can_change(true);
	_obj[2, 08] =	new LMObject(oKeyTallWide,		32, 32).set_sprite_button_part(sKeyDoorTallWideUI, 0, 0, 0, -8, -8).set_can_change(true);
	_obj[2, 09] =	new LMObject(oKeyDoorTallWide,	32, 32).set_sprite_button_part(sKeyDoorWideTall, 0, 0, 0, -8, -8).set_can_change(true);
	_obj[2, 10] =	new LMObject(oMagicOrb,			16, 16, SPRITE_ORIGIN.BOTTOM).add_tag("is_unique").set_can_change(true);
	_obj[2, 11] =	new LMObject(oStarFly,			16, 16).set_can_change(true);
